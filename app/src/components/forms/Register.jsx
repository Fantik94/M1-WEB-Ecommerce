    ...
    <div className="font-sans bg-gradient-to-r from-purple-900 via-purple-800 to-purple-600 text-gray-800 dark:text-gray-200">
      <div className="min-h-screen flex flex-col items-center justify-center lg:p-6 p-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          ...
          <form className="bg-white dark:bg-gray-800 rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto w-full" onSubmit={handleSubmit}>
            ...
            <div>
              <input
                ...
                autoComplete="email"
                required
                className="bg-gray-100 dark:bg-gray-700 dark:text-gray-200 focus:bg-transparent w-full text-sm px-4 py-3.5 rounded-md outline-gray-800 dark:outline-gray-200"
