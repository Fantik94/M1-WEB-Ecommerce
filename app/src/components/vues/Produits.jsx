        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-md p-6 rounded-lg">
          <div className="lg:col-span-3 w-full lg:sticky top-0 text-center">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-6 mx-auto">
              {['1', '2', '3'].map(num => (
                <div
                  key={num}
                  className="w-24 h-20 flex items-center justify-center rounded-lg p-4 shadow-md cursor-pointer"
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-2 mt-4">
              {[...Array(4)].map((_, i) => (
                <svg key={i} className="w-5 fill-primary-700" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <button
                type="button"
                className={`min-w-[200px] px-4 py-3 ${product.stock < 1 ? 'bg-gray-400 cursor-not-allowed' : 'bg-primary-700 hover:bg-blue-700'} text-white text-sm font-semibold rounded`}
