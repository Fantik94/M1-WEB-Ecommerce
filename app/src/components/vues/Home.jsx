  ...
  return (
    <div>
      ...
      <div className="p-4">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-extrabold text-gray-900 md:text-3xl lg:text-4xl">Témoignages</h2>
          <p className="mt-4 text-lg font-normal text-gray-500 lg:text-xl">
