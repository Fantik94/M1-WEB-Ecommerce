// src/components/vues/Comment.jsx
...
const Comment = ({ name, dateJoined, rating, title, reviewDate, reviewText, helpfulCount }) => {
  ...
  return (
    <article className="p-6 mb-6 text-base bg-white border border-gray-200 rounded-lg shadow-md">
      <div className="flex items-center mb-4">
        ...
        <div className="font-medium text-gray-900">
          <p>
            {name} <time className="block text-sm text-gray-500">A rejoint en {dateJoined}</time>
          </p>
        </div>
      </div>
      ...
      <p className="mb-2 text-gray-500">{reviewText}</p>
